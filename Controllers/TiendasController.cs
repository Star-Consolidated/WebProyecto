...
namespace WebProyecto.Controllers
{
    ...
    public class TiendasController : Controller
    {
        ...
        public TiendasController(ShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Nombre,Correo,Contraseña,Telefono")] Tienda tienda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nombre,Correo,Contraseña,Telefono")] Tienda tienda)
        {
            if (id != tienda.ID)
            {
                return NotFound();
